...
6. 提炼一个 6-14 个汉字的封面短标题，保留文章核心信息，不使用标点、引号或营销套话；优先用中文与阿拉伯数字，除 AI 外不要使用英文品牌名或模型名。
...
- 顶层 cover_title 必须是 6-14 个汉字的封面短标题，准确概括文章核心，不使用标点、引号或营销套话；优先用中文与阿拉伯数字，除 AI 外不要使用英文品牌名或模型名。
